...
function openItem(id){
  ...
  openSheet(`
    ...
    ${(it.gcalEventId || it.gcalEvId) ? `<button class="sheet-btn" onclick="openItemCal()"><span>${ICON.cal}</span> Calendar event: ${esc(it.gcalTime||"")}${it.gcalTime?" on ":"On "}${esc(it.gcalCalName||"calendar")}…</button>` : ""}
